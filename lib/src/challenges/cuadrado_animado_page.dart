...
class _CuadradoAnimadoState extends State<_CuadradoAnimado>
  ...
  void initState() {
    ...
    controller = AnimationController(
        vsync: this, duration: const Duration(milliseconds: 4250));
